cookies7={'wb_view_log': '1366*7681', 'WBStorage': 'bfb29263adc46711|undefined', 'Ugrow-G0': '57484c7c1ded49566c905773d5d00f82', 'login_sid_t': '28d24c8bec26d7b7845f3aa9043b7f37', 'cross_origin_proto': 'SSL', 'YF-V5-G0': '572595c78566a84019ac3c65c1e95574', 'YF-Page-G0': 'a478b43c3fd6f5a258feb64dc37bff16', '_s_tentry': 'passport.weibo.com', 'SINAGLOBAL': '9474635671946.521.1545554643914', 'Apache': '9474635671946.521.1545554643914', 'ULV': '1545554643921:1:1:1:9474635671946.521.1545554643914:', 'SUHB': '0mxE3IyqfArx0U', 'SUBP': '0033WrSXqPxfM725Ws9jqgMF55529P9D9WhKQWPVKCzTjip7szOAcD4j5JpX5K-hUgL.FoqNehqX1KBXSo-2dJLoIp7LxKML1KBLBKnLxKqL1hnLBoMcS05cSh.XShqf', 'ALF': '1548146651', 'SSOLoginState': '1545554682', 'SCF': 'AogWo90FvJ91pPRqx3ICkiU09HJt-BBvaXkOViGL7GqOwUwzjfTqL2UUCkNumjgkcr2sGqx8Y6SLT7pAbw4DdOA.', 'SUB': '_2A25xGzqqDeRhGeBJ61QV-SrIzTmIHXVS5EbirDV6PUJbktAKLRGskW1NRnSsCQx4M33U5zSJECBNLcf902yqd-P3', 'un': 'iqzz5wxzc2zm@game.weibo.com', 'WEIBOCN_FROM': '1110006030', '_T_WM': 'd52c292d09e5e3c99aefe28582197860', 'MLOGIN': '1', 'M_WEIBOCN_PARAMS': 'luicode%3D10000011%26lfid%3D2302835723535900%26fid%3D2302835723535900_-_INFO%26uicode%3D10000011'}
user_res=requests.get(user_info_url,headers=headers,cookies=cookies7)

homeres=requests.get(home.format('6208238296','6208238296'),cookies=cookies7).json()

# comp=requests.get('https://m.weibo.cn/api/container/getIndex?containerid=2302832954769872_-_INFO&title=%E5%9F%BA%E6%9C%AC%E8%B5%84%E6%96%99&luicode=10000011&lfid=2302832954769872',cookies=cookies7).text
# print(comp['data']['cards'])

winres=requests.get(win,cookies=cookies6,headers=headers)

pc='https://event.weibo.com/yae/aj/event/lottery/result?pageid=100140E3131412&id=2110002&page=1&prizeLevel=1&_t=0'
winres_pc=requests.get(pc,cookies=cookies6,headers=headers)

# print('comp:{}'.format(comp))
print('winner_pc:{}'.format(winres_pc.text))
pass
print('-'*30)
print('userinfo:{}'.format(user_res.text))
print('-'*30)
print('winner_mobile:{}'.format(winres.json()))
print('-'*30)
print('home:{}'.format(homeres))
